...
class ProfileScreen extends StatefulWidget {
  ...
  const ProfileScreen({super.key, required this.userId, required this.gradeId});
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final String initialChar = nameText.isNotEmpty && nameText != "Chưa có tên"
                        ...
                        child: Column(
                          children: [
                            Row(
                              children: [
                                ...
                                _profileData?.avatarUrl != null &&
                                        _profileData!.avatarUrl!.isNotEmpty
                                    ? CircleAvatar(
                                        radius: 35,
                            ...
                            Row(
                              ...
                              children: [
                                _buildQuickStat(
                                  "${_profileData?.totalXp ?? 0}",
                                  "Tổng XP",
                                ),
                                _buildQuickStat(
                                  "${_profileData?.totalLesson ?? 0}",
                                  "Bài đã học",
                                ),
                                _buildQuickStat(
                                  "${_profileData?.streakDay ?? 0}",
                                  "Streak",
                                ),
                              ],
                            ),
