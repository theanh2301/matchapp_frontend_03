                        ...
                        children: [
                          AuthToggleSwitch(
                            ...
                            onToggle: (value) => setState(() {
                              ...
                              _selectedClassId =
                                  null; // Reset lại dropdown khi chuyển tab
                            }),
                          ),
    ...
    return Column(
      children: [
        ...
        Row(
          children: [
            Expanded(
              child: _buildSocialBtn("Google", Icons.g_mobiledata, Colors.red),
            ),
            const SizedBox(width: 16),
            Expanded(
              child: _buildSocialBtn("Facebook", Icons.facebook, Colors.blue),
            ),
          ],
        ),
      ],
